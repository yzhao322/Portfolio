    ...
    <div className="portfolio-content">
      <Carousel>
        ...
        <Carousel.Item>
          ...
          <p>An application that allows the user to find a recipe based on a range of calories and the ingredients of choice.</p>
        </Carousel.Item>
        <Carousel.Item>
          <img
            className="d-block w-100"
          ...
          <p>This Weather Forecast Application use the OpenWeather API to help user to get the weather data in five days for cities.</p>
        </Carousel.Item>
        <Carousel.Item>
          <img
            className="d-block w-100"
          ...
          <p>Small Quiz Game which contains combination of multiple-choice questions</p>
        </Carousel.Item>
      </Carousel>
    </div>
  );
